 ...
 *
 * @category Source
 * @package  DzUserModule\Controller
 * @author   Adrien Desfourneaux (aka Dieze) <dieze51@gmail.com>
 * @license  http://www.opensource.org/licenses/mit-license.html  MIT License
 * @link     https://github.com/dieze/DzUserModule
 */

namespace DzUserModule\Controller;

use Zend\Form\Form;
use Zend\Mvc\Controller\AbstractActionController;
use Zend\View\Model\ViewModel;
use DzUserModule\Service\User as UserService;
 ...
 * @author   Adrien Desfourneaux (aka Dieze) <dieze51@gmail.com>
 * @license  http://www.opensource.org/licenses/mit-license.html  MIT License
 * @link     http://github.com/dieze/DzUserModule/blob/master/src/DzUserModule/Controller/UserController.php
...
class UserController extends \ZfcUser\Controller\UserController
{
    ...
    const ROUTE_ACCOUNT   = 'dzuser/account';
    ...
    {
        return $this->viewmodel('DzUserModule\IndexViewModel');
    }
    ...
    public function getOptions()
    {
        if (!$this->options instanceof UserControllerOptionsInterface) {
            $this->setOptions($this->getServiceLocator()->get('DzUserModule\ModuleOptions'));
        }
        return $this->options;
    }
}
